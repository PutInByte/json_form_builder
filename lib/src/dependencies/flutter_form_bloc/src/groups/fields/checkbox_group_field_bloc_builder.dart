          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                BlocBuilder<MultiSelectFieldBloc<Value, dynamic>, MultiSelectFieldBlocState<Value, dynamic>>(
                  ...
                  builder: (context, state) {
                    ...
                    return DefaultFieldBlocBuilderPadding(
                      ...
                      child: InputDecorator(
                        decoration: _buildDecoration(context, state, isEnabled, fieldTheme),
                        child: _buildCheckboxes(context, state, isEnabled, fieldTheme),
                      ),
                    );
                  },
                )
    ...
    return DefaultTextStyle(
      ...
      child: GroupView(
        ...
        builder: (context, index) {
          ...
          final onChange = fieldBlocBuilderOnChange<bool?>(
            isEnabled: isEnabled,
            ...
            onChanged: (isChecked) {
              ...
              if (onChanged != null)
                onChanged!(multiSelectFieldBloc.value.length != 0);
          ...
          return ItemGroupTile(
            ...
            onTap: fieldTheme.canTapItemTile && onChange != null ? () => onChange(!state.value.contains(item)) : null,
            leading: Container(
