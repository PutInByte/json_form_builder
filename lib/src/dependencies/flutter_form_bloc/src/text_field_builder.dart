...
class _TextFieldBlocBuilderState extends State<TextFieldBlocBuilder> {
  ...
  Widget build(BuildContext context) {
    ...
    return CanShowFieldBlocBuilder(
      ...
      builder: (_, __) {
        return Container(
          margin: EdgeInsets.only(bottom: widget.withBottom ? 32 : 0),
          child: Column(
  ...
  Widget _buildTextField({
    ...
    return TypeAheadField<String>(
      ...
      loadingBuilder: widget.loadingSuggestionsBuilder ?? (context) {
            return Container(
      ...
      noItemsFoundBuilder: widget.suggestionsNotFoundBuilder ?? (context) {
            return Container(
              height: _kMenuItemHeight,
              alignment: AlignmentDirectional.center,
      ...
      suggestionsBoxDecoration: widget.suggestionsBoxDecoration ?? SuggestionsBoxDecoration(
