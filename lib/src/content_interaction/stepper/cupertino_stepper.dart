...
import 'package:flutter/material.dart'
    show ControlsDetails, ControlsWidgetBuilder, Icons, Step, StepState, StepperType, Theme;
...
class _CupertinoStepperState extends State<CupertinoStepper> with TickerProviderStateMixin {
    ...
    switch (state) {
      ...
      case StepState.complete:
        return Icon(
          Icons.check,
          color:
              isActive ? CupertinoDynamicColor.resolve(CupertinoColors.white, context) : Theme.of(context).primaryColor,
          size: _kStepFontSize * 2, // ### TODO: why is check_mark so small?
        );
      case StepState.error:
        return const Text('!', style: TextStyle(fontSize: _kStepFontSize, color: CupertinoColors.white));
    }
  }

  Color? _circleColor(int index) {
    return widget.steps[index].isActive ? Theme.of(context).primaryColor : null;
  }
    ...
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: ShapeDecoration(
          ...
          shape: CircleBorder(
            side: BorderSide(color: _borderColor(index), width: 2),
          ),
        ),
        child: Center(
  ...
  Widget _buildVerticalControls() {
    if (widget.controlsBuilder != null) {
      return widget.controlsBuilder!(
          context,
          ControlsDetails(
              currentStep: 0, stepIndex: 0, onStepContinue: widget.onStepContinue, onStepCancel: widget.onStepCancel));
    }
  ...
  TextStyle _titleStyle(int index) {
    ...
    switch (widget.steps[index].state) {
      ...
      case StepState.disabled:
        return textTheme.navActionTextStyle
            .copyWith(color: CupertinoDynamicColor.resolve(CupertinoColors.placeholderText, context));
      case StepState.error:
        return textTheme.navActionTextStyle
      ...
      children: <Widget>[
        for (int i = 0; i < widget.steps.length; i += 1)
          Column(
            ...
            children: <Widget>[
              Padding(
                padding: const EdgeInsetsDirectional.only(start: _kStepMargin + (_kStepSize - _kLineWidth) / 2),
  ...
  Widget _buildHorizontal() {
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          constraints: const BoxConstraints(maxWidth: 1333, minWidth: 800),
          margin: const EdgeInsets.symmetric(horizontal: _kStepMargin),
          child: Row(
            children: children,
          ),
